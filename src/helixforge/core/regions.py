...
def validate_region(
    ...
    """
    # v3 glue: v1's GenomeAccessor exposed a ``scaffold_lengths`` property; v3's
    # GenomeAccessor (reused here) exposes ``get_scaffold_lengths()`` instead.
    scaffold_lengths = genome.get_scaffold_lengths()
